...
const EditBoard = (props) => {
    ...
    const [score_to_win, setScoreToWin] = useState(props.gameState.score_to_win);
        ...
        <div className="EditBoard">
            <form onSubmit={(e) => onSubmit(e)}>
                <div className="input">
                    ...
                    <input type="text" name="teamA" id="teamAInput" value={teamA} onChange={(e) => onTeamAUpdate(e)}/>
                </div>
                <div className="input">
                    <label htmlFor="teamB">Team B:</label>
                    <input type="text" name="teamB" id="teamBInput" value={teamB} onChange={(e) => onTeamBUpdate(e)}/>
                </div>
                <div className="input">
                    <label htmlFor="scoreA">Score A:</label>
                    <input type="number" name="scoreA" id="scoreAInput" value={scoreA} onChange={(e) => onScoreAUpdate(e)}/>
                </div>
                <div className="input">
                    <label htmlFor="scoreB">Score B:</label>
                    <input type="number" name="scoreB" id="scoreBInput" value={scoreB} onChange={(e) => onScoreBUpdate(e)}/>
                </div>
                <div className="input">
                    <label htmlFor="scoreToWin">Score to win:</label>
                    <input type="number" name="scoreToWin" id="scoreToWinInput" value={score_to_win} onChange={(e) => onScoreToWinUpdate(e)}/>
                </div>
                <div className="buttons">
                    <button type="submit">Submit</button>
                    <button id='cancel-button' onClick={(e) => cancelEdit(e)}>Cancel</button>
                </div>
            </form>
        </div>
    )
